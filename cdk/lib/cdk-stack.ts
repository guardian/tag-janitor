...
export class CdkStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const accountsAllowListParameter = new cdk.CfnParameter(this, "accountsAllowList", {
      type: "String",
    ...
    const tagJanitorLambda = new lambda.Function(
      this,
      `${app}-lambda`,
      {
        ...
        environment: { STAGE: stageParameter.valueAsString, TOPIC_ARN: topicParameter.valueAsString, ACCOUNTS_ALLOW_LIST: accountsAllowListParameter.valueAsString },
